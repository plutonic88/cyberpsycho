...
Vue.component('node',{
	...
	methods : {
			...
			// 	var def_action_probs = [];
			// 	//var def_actions = [];

			// 	if(vm.numberofround===1)
			// 	{
			// 		def_action_probs = (def_strategy["EMPTY"]["EMPTY"]);
			// 	}
			// 	else
			// 	{
			...
			// 		 if ((def_strategy[vm.defender_sequence][vm.attacker_sequence])===undefined)
			// 		 {
			// 		 	console.log("Sequence undefined *******************  ");
			// 		 	//return action uniformly
			// 		 	console.log("BHVRLSTRAT : returning action randomly  ");
			// 		 	return Math.floor((Math.random() * 5) + 0);
			// 		 }
			// 		def_action_probs = (def_strategy[vm.defender_sequence][vm.attacker_sequence]);
			// 	}
			...
			// 	for(var k=0; k<def_action_probs.length; k++)
			// 	{
			// 		console.log("^^^^^^^^^^^^Def actions " + def_action_probs[k][0] +" : "+ def_action_probs[k][1]);
			// 	}
			...
			// 	while (a < (def_action_probs.length)) 
			// 	{

			// 		cumulativeProbability += parseFloat(def_action_probs[a][1]);
			// 		//console.log("r : "+r+", cumulativeProbability : " + cumulativeProbability);
			...
			makeDefenderMove : function()
			{
				...
				// var defaction = vm.defenderBHVRLStrategy();	
	...
	created () {
		...
		//	}).begin();
			...
			axios.get('/configprac').then(function(response){
