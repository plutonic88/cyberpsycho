          ...
          <div class="card card-outline-primary" style="width: 100%; height: 21.5rem;">
            <div class="card-block">
                  ...
                  <div id="nodebuttons" class="visible">
                      ...
                      <node :id="0"  class=" buton node0-pos " v-bind:neighbors="[]"  v-on:applied="onCouponApplied(id)" v-bind:cla="[true, false, false, false]"  v-bind:nodevalues= "[10, 2, 1]"></node>
                      <node :id="1" class="  buton node1-pos " v-bind:neighbors="[]" v-on:applied="onCouponApplied(id)" v-bind:cla="[true, false, false, false]" v-bind:nodevalues= "[8, 6, 1]"></node> 
                      <node :id="2"  class="buton node2-pos" v-bind:neighbors="[]"  v-on:applied="onCouponApplied(id)" v-bind:cla="[true, false, false, false]" v-bind:nodevalues= "[0, 0, 0]"></node>
...
<script src="{{ asset('js/prac-fullinfo.js') }}"> </script>
